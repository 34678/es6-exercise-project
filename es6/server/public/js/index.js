...
var copyProperties = function copyProperties(target, source) {
    ...
    try {
        for (var _iterator = Reflex.ownKeys(source)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var key = _step.value;
...
var Lottery = function (_min) {
    ...
    _createClass(Lottery, [{
        ...
        value: function initEvent() {
            var self = this;
            (0, _jquery2.default)('#play').on('click', 'li', self.changePlayNav.bind(self));
            (0, _jquery2.default)('.boll-list').om('click', '.btn-boll', self.toggleCodeAcitive.bind(self));
            (0, _jquery2.default)('#comfirm_sel_code').on('click', self.addCode.bind(self));
            (0, _jquery2.default)('.dxjo').on('click', 'li', self.assistHandle.bind(self));
            (0, _jquery2.default)('qkmethond').on('click', '.btn-middle', self.getRandom.bind(self));
        }
    }]);

    return Lottery;
}(min(_base2.default, _timer2.default, _calculate2.default, _Interface2.default));
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //放在对象的私有属性里面 达到基本信息的共享
/**
 * 模块化
 * class声明类更容易
 * map数据结构 级联操作？
...
var Base = function () {
    ...
    _createClass(Base, [{
        ...
        value: function setOpenCode(code) {
            ...
            try {
                for (var _iterator2 = code.valueOf()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        key: 'toggleCodeAcitive',
        value: function toggleCodeAcitive(e) {
            var self = this;
        ...
        value: function changePlayNav(e) {
            ...
            (0, _jquery2.default)('.boll-list .btn-bol').removeClass('btn-boll-active');
            self.getCount();
        }
        ...
        value: function assistHandle(e) {
            ...
            (0, _jquery2.default)('.boll-list .btn-bol').removeClass('btn-boll-active');
            if (index === 0) {
                (0, _jquery2.default)('.boll-list .btn-bol').addClass('btn-boll-active');
            }
            if (index === 1) {
                (0, _jquery2.default)('.boll-list .btn-bol').each(function (i, t) {
        ...
        value: function addCodeItem(code, type, typeName, count) {
            var self = this;
            var tpl = '<li class="" codes="' + type + '|' + code + '" bonus="' + count * 2 + '"><span class="del" count="1">\u5220\u9664</span><span class="modi" count="' + count + '">\u4FEE\u6539</span><div class="code"><b>' + typeName + (count > 2 ? "复式" : "单式") + '</b><b class="em">' + code + '</b>  [' + count + '\u6CE8,<em class="code-list-money">' + count * 2 + '</em>\u5143]</div></li>\n        ';
    ...
    _createClass(Timer, [{
        ...
        value: function countdown(end, update, handle) {
            ...
            if (now - end) {
                ...
                var _s = Math.floor((last_time - d * px_d - h * px_h - m * px_m) / px_s);
                var _r = [];
                if (d > 0) {
                    //字符串模板 省去拼接的过程
                    _r.push('<em>' + d + '</em>\u5929');
                ...
                if (_r.length || m > 0) _r.push('<em>' + m + '</em>\u5206');
            }
            if (r.length || s > 0) {
                r.push('<em>' + s + '</em>\u79D2');
            }
